...
<div id="select-chat-room" style="width:400px; height:690px; position: fixed; border: 1px solid grey;">
		<div class="chat-user">
			<div class="chat-usernickname">${prd_user_name}</div>
		</div>
		<div class="chat-top">
    ...
    <script type="module">
		...
		function youappendMessage(msg, sendTime, time, idnum) {
    		...
    		textBoxYou.append(sendTimeYou, sendMsgYou);
